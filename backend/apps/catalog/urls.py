...
from .admin_views import (
    ...
    AdminCharacterImageFromUrlView,
...
urlpatterns = [
    ...
    path(
        "admin/characters/<int:character_id>/images/from-url",
        AdminCharacterImageFromUrlView.as_view(),
        name="admin-character-image-from-url",
    ),
    path(
